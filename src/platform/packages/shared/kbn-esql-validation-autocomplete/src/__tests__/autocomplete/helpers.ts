...
import type { EditorContext, SuggestionRawDefinition } from '../../autocomplete/types';
import {
  TIME_SYSTEM_PARAMS,
  TRIGGER_SUGGESTION_COMMAND,
  getSafeInsertText,
} from '../../autocomplete/factories';
import { ESQLFieldWithMetadata } from '../../lib/validation/types';
import {
  FieldType,
  fieldTypes,
...
import { joinIndices, timeseriesIndices } from '../helpers';
